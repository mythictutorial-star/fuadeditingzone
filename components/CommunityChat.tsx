                ...
                <main className={`${isMobileChatOpen || isActivityOpen ? 'flex' : 'hidden'} md:flex flex-1 flex-col min-h-0 bg-black animate-fade-in relative`}>
                  {isActivityOpen ? (
                    ...
                    <>
                      ...
                      <div className="px-3 py-4 md:px-10 md:py-8 bg-black border-t border-white/10 flex-shrink-0 z-50">
                        {isSignedIn ? (
                          <div className="max-w-4xl mx-auto flex flex-col gap-2">
                            {isInputLocked ? (
                              ...
                              <div className="flex items-end gap-2 p-1.5 border border-white/15 rounded-3xl transition-all focus-within:border-red-600/40 focus-within:bg-white/[0.02] mx-1">
                                ...
                                />
                                <div className="flex items-center gap-2 pr-3 self-center">
                                    {(inputValue.trim() || pendingMedia) && (
                                        <button onClick={() => handleSendMessage()} disabled={isMediaUploading} className="text-red-600 hover:text-red-500 font-black uppercase text-[11px] tracking-widest transition-all active:scale-90 disabled:opacity-50">
